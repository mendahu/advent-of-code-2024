...
if (!questionNumber) {
    console.error("Please provide a question number as your first arguement on the CLI command. You can use a number and a letter for each part, like 1a or 2b.");
    process.exit(1);
}
try {
    const { default: qFunc } = await import(path.resolve(`./dist/questions/${questionNumber}/index.js`));
